...
This guide explains how to use the Configuration features in the Mangy Dog Coffee Voice Assistant Admin Panel.

**Access**: `http://localhost:8030/admin?token=local-dev-token`
...
**Main English Agent:**
```
You are a helpful assistant for Mangy Dog Coffee.
...
**Spanish Agent:**
```
Eres un asistente útil para Mangy Dog Coffee.
...
**Sales-Focused Agent:**
```
You are a sales-focused assistant for Mangy Dog Coffee.
Your primary goal is to help callers discover our coffee products.
Highlight the benefits: quality beans, expert roasting, subscription savings.
Mention subscription options when appropriate.
